...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录WeShop管理平台</title>
        <link rel="stylesheet" type="text/css" href="/Public/Admin/css/login.css?v=<?php echo SITE_VERSION;?>" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>WeShop管理平台</h3>
